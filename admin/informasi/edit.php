                ...
                <div class="flex flex-col lg:flex-row items-stretch w-full gap-4">
                    <div class="flex-1 flex flex-col gap-4">
                        <label class="block">
                            ...
                            <input name="title" required value="<?= $judul?>" class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 px-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Post title"/>
                        </label>
                        <label class="block">
                            ...
                            <div class="wrapper-description">
                                <textarea id="description" name="description" class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 px-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Your content.."><?=$deskripsi?></textarea>
                    ...
                    <div class="w-full lg:w-64 space-y-4">
                        <label class="block">
                            ...
                            <div class="upload text-center img-thumbnail upload-container">
                                ...
                                <input type="file" name="cover" required id="customFile" class="dropify custom-file-input" data-default-file="<?= $cover? "./../../dist/images/informasi/$cover": "./../../dist/images/noimage.jpg"?>" data-max-file-size="1M" />
                                <input name="temp_file" type="hidden" value="<?=$cover?>">
                            </div>
                        </label>
...
<script>
    ...
    $('body').on('click', '#btn-submit', function(e){
        ...
        axios({
            url: './../../process/updateInformasi.php?id=<?=$id?>',
            method: 'post',
            data: formData,
            dataType: 'json',
        })
