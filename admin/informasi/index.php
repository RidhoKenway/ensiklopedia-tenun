 ...
 ">
  ...
  <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
    <ul class="space-y-1.5">
      ...
      <li>
        <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-neutral-700 rounded-lg hover:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="./informasi/index.php">
...
<div class="w-full lg:ps-64">
  <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
    ...
    <h2 class="text-2xl">Informasi</h2>
    <a href="./add.php" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path></svg> Tambah Informasi</a>
    </div>
    <div class="card">
        <div class="card-body">
            <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./edit.php?id=<?= $row['id'] ?>" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-teal-500 text-white hover:bg-teal-600 disabled:opacity-50 disabled:pointer-events-none">Edit</a>
                            <a data-id="<?= $row['id'] ?>" class="btn-hapus py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none">Hapus</a>
                        </td>
                    </tr>
                    <?php
                        }
    ...
    $('body').on('click', '.btn-hapus', function(e){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios({
            url: './../../process/hapusInformasi.php?id='+id,
            method: 'delete',
            dataType: 'json',
          })
          .then((response)=>{
