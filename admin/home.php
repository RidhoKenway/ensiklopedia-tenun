 ...
 ">
  ...
  <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
    <ul class="space-y-1.5">
      <li>
        <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-neutral-700 rounded-lg hover:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="./home.php">
      ...
      <li><a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-neutral-700 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300" href="./informasi/index.php">
...
<div class="w-full lg:ps-64">
  ...
  <div class="flex justify-between gap-4">
    <h2 class="text-2xl">SELAMAT DATANG <?= $_SESSION['nama']?></h2>
    </div>
  </div>
</div>
<!-- End Content -->
